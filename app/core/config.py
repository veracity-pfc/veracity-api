...
class Settings(BaseSettings):
    ...
    access_token_expire_seg: int = Field(
        default=60,
        alias="ACCESS_TOKEN_EXPIRE_SEG",
    )
    ...
    sight_engine_api_user: str = Field(
        ...,
        alias="SIGHT_ENGINE_API_USER",
    )
    sight_engine_api_secret: str = Field(
        ...,
        alias="SIGHT_ENGINE_API_SECRET",
    )
